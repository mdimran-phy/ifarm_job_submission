...
void sep_gr_geo_comparison_reco()
{
  TFile *file_standalone[25];
  TTree *tree_standalone[25];

  TString path_standalone("/w/halld-scshelf2101/halld3/home/ihossain/gr_dn_HRPPD_reco/output_files/");
  ...
  Double_t sep_gr_standalone_5_4[25];
  Double_t sep_gr_err_standalone_5_4[25];

  Double_t sep_gr_standalone_mcp[25];
  Double_t sep_gr_err_standalone_mcp[25];
  ...
  for(int j=0; j < 25; j++)
    {      
      ...
      sep_gr_standalone_5_4[j] = sep_gr;
      sep_gr_err_standalone_5_4[j] = sep_gr_err;
      ...
      sep_gr_standalone_mcp[j] = sep_gr;
      sep_gr_err_standalone_mcp[j] = sep_gr_err;
      
      //imran code
      gr1[0] = new TGraphErrors(25, theta, sep_gr_standalone, theta_err, sep_gr_err_standalone);
      gr1[1] = new TGraphErrors(25, theta, sep_gr_standalone_5_4, theta_err, sep_gr_err_standalone_5_4);
      gr1[2] = new TGraphErrors(25, theta, sep_gr_standalone_mcp, theta_err, sep_gr_err_standalone_mcp);
    }
  ...
  mg->SetTitle("Separation Power at 6 GeV/c - geometric reco. for standard HRPPD vs 116640k dn per Pmt vs mcp_pmt");                                             
