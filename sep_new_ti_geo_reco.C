...
void sep_new_ti_geo_reco()
{
  TFile *file_standalone[25];
  TTree *tree_standalone[25];

  TString path_standalone("/w/halld-scshelf2101/halld3/home/ihossain/ti_update_reco_timecut_0.2/output_files/");
  ...
  gr1->SetTitle("Separation Power at 6 GeV/c - time imaging reco. old vs new");
